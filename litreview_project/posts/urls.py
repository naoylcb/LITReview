...
urlpatterns = [
    ...
    path('delete/ticket/<ticket_title>', views.delete_ticket, name='delete_ticket'),
    path('edit/review/<review_headline>', views.edit_review, name='edit_review'),
    path('delete/review/<review_headline>', views.delete_review, name='delete_review'),
]